  ...
  const principles = [
    {
      ...
      description: "Every dish begins with sourcing. We work with farmers, foragers, and artisans who share our reverence for quality. The ingredient teaches us what the dish should become."
    },
    {
      number: "02", 
      title: "Technique as Language",
      description: "We honor French foundations while embracing innovation. Sous-vide precision, fermentation depth, classical sauces reimagined—technique serves expression, never overshadows it."
    },
    {
      number: "03",
      title: "Seasonality Over Trend",
      description: "Fashion fades. We compose menus that celebrate the moment—spring peas at their sweetest, summer stone fruit at peak, autumn game in its glory. Nature dictates our rhythm."
    },
    {
      number: "04",
      title: "Memory as Measure",
      description: "Cuisine exists to create lasting impressions. Every flavor combination, every textural contrast, every visual composition is calibrated to leave an indelible mark on your palate and memory."
    }
  ]
        ...
        >
          <div className="relative aspect-[21/15.35] overflow-hidden">
            <ImageReveal
              ...
              alt="Chef preparing fresh ingredients in ESSENCE kitchen"
