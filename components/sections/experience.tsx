  ...
  const steps = [
    {
      ...
      timing: "Arrival",
      title: "The Welcoming",
      description: "Your evening begins in our lounge with a signature cocktail and amuse-bouche. A moment to transition from the outside world into our culinary universe.",
    ...
    },
    {
      ...
      description: "Three to four opening courses that introduce the evening's themes. Delicate preparations that tease and intrigue, building anticipation for what follows.",
    ...
    },
    {
      ...
      description: "The centerpiece courses where technique, ingredient, and vision converge. This is where the menu reaches its emotional and gustatory crescendo.",
    ...
    },
    {
      ...
      description: "A progression of desserts that provide resolution and reflection. From pre-dessert through final mignardises, a gentle descent that completes the narrative.",
          ...
          <div className="lg:col-span-10">
            ...
            >
              <ImageReveal
                ...
                alt="Chef carefully plating signature dish with precision"
